#############################################################################
# Makefile for building: HotKeyMacro
# Generated by qmake (3.1) (Qt 6.8.1)
# Project:  HotKeyMacro.pro
# Template: app
# Command: C:\Qt\6.8.1\mingw_64\bin\qmake.exe -o Makefile HotKeyMacro.pro
#############################################################################
...
Makefile: HotKeyMacro.pro C:/Qt/6.8.1/mingw_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.8.1/mingw_64/mkspecs/features/spec_pre.prf \
		...
		src/resources.qrc
	$(QMAKE) -o Makefile HotKeyMacro.pro
